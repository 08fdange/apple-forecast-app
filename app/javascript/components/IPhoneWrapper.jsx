  ...
  return (
    <div className="flex justify-center items-center h-screen overflow-hidden">
      <div className="relative h-[90vh] max-h-[800px] w-auto">
        ...
        <div className="absolute z-20 top-[22px] left-[38%] w-16 h-7 bg-black rounded-full" />
        ...
        <div 
          className="absolute z-0 top-[13px] bottom-[12px] left-[16px] right-[16px] rounded-[46px]"
          style={{
        ...
        <div className="absolute z-10 top-0 left-0 right-0 bottom-0 flex justify-center items-center">
          <div className="w-[94%] h-[97%] rounded-t-[58px] rounded-b-[53px] overflow-scroll p-4">
            {children}
          </div>
        </div>
      </div>
